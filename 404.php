...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0;}
    body{background:#1a3a5c;color:#fff;font-family:'Poppins',sans-serif;display:flex;align-items:center;justify-content:center;min-height:100vh;text-align:center;padding:24px;}
    .wrap{max-width:480px;}
    .logo{width:80px;margin-bottom:24px;opacity:.9;}
    h1{font-size:96px;font-weight:700;color:#27ae60;line-height:1;}
    h2{font-size:22px;font-weight:600;margin:12px 0 8px;}
    p{font-size:15px;opacity:.75;line-height:1.6;margin-bottom:28px;}
    .btn{display:inline-block;background:#27ae60;color:#fff;padding:12px 32px;border-radius:30px;text-decoration:none;font-weight:600;font-size:15px;letter-spacing:.5px;transition:background .2s;}
