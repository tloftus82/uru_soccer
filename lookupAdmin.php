...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    header("Location: lookupAdmin.php?v=$viewCode&tab=".urlencode($activeTab)."&msg=".urlencode($flashMsg)."&msgtype=$flashType");
    exit;
}
...
<div class="uru-header">
  <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
    ...
    <div class="d-flex gap-2">
      <a href="playerAdmin.php?v=<?=$viewCode?>" class="btn btn-outline-light btn-sm"><i class="fas fa-user me-1"></i>Player Admin</a>
...
function rowActions($fa,$viewCode,$table,$id,$activeTab){
  ...
  <div class="card-section">
    ...
    <table class="table table-hover table-sm">
      ...
      <tr>
        ...
        <?php rowActions($fa,$viewCode,'POSITION',$row['ID'],'tab-positions');?>
      </tr>
      <?php endforeach;?>
      </tbody>
    </table>
  ...
  <div class="card-section">
    ...
    <table class="table table-hover table-sm">
      ...
      <tr>
        ...
        <?php rowActions($fa,$viewCode,'LOCATION',$row['ID'],'tab-locations');?>
      </tr>
      <?php endforeach;?>
      </tbody>
    </table>
  ...
  <div class="card-section">
    ...
    <table class="table table-hover table-sm">
      ...
      <tr>
        ...
        <?php rowActions($fa,$viewCode,'ORG',$row['ID'],'tab-orgs');?>
      </tr>
      <?php endforeach;?>
      </tbody>
    </table>
  ...
  <div class="card-section">
    ...
    <table class="table table-hover table-sm">
      ...
      <tr>
        ...
        <?php rowActions($fa,$viewCode,'CONTACT',$row['ID'],'tab-contacts');?>
      </tr>
      <?php endforeach;?>
      </tbody>
    </table>
  ...
  <div class="card-section">
    ...
    <table class="table table-hover table-sm">
      ...
      <tr>
        ...
        <?php rowActions($fa,$viewCode,'TIMEPERIOD',$row['ID'],'tab-periods');?>
      </tr>
      <?php endforeach;?>
      </tbody>
    </table>
  ...
  <div class="card-section">
    ...
    <table class="table table-hover table-sm">
      ...
      <tr>
        ...
        <?php rowActions($fa,$viewCode,'VIDEOTYPE',$row['ID'],'tab-periods');?>
      </tr>
      <?php endforeach;?>
      </tbody>
    </table>
  ...
  <div class="card-section">
    ...
    <table class="table table-hover table-sm">
      ...
      <tr>
        ...
        <?php rowActions($fa,$viewCode,'REFTYPE',$row['ID'],'tab-periods');?>
      </tr>
      <?php endforeach;?>
      </tbody>
    </table>
  ...
  <div class="card-section">
    ...
    <table class="table table-hover table-sm">
      ...
      <tr>
        ...
        <?php rowActions($fa,$viewCode,'VIEWER',$row['ID'],'tab-viewers');?>
      </tr>
      <?php endforeach;?>
      </tbody>
    </table>
