	  ...
	  <div class="section started" id="section-started">
	    <div class="centrize full-width">
		  <div class="vertical-center">
            <div class="started-content" style="<?= $showFliers ? 'display:flex;gap:32px;align-items:flex-start;flex-wrap:wrap;' : '' ?>">

              <!-- Welcome text -->
              <div style="<?= $showFliers ? 'flex:1;min-width:260px;' : '' ?>">
                <h1 class="h-title">
              ...
              <!-- Training fliers (inline, same viewport) -->
              <?php if ($showFliers): ?>
              <div style="flex:1;min-width:260px;">
                <div style="font-size:13px;font-weight:700;letter-spacing:1px;text-transform:uppercase;opacity:.6;margin-bottom:10px;">
